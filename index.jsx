  ...
  return (
    <nav>
      <div className="nav-brand" onClick={() => setPage("home")} style={{ cursor: "pointer" }}>
        ...
        <span className="sub">Hickory Hills, IL · Est. 2000</span>
      </div>
      ...
      <div className="footer-grid">
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li><span><a href="mailto:salaiseshomeimprovement@gmail.com">salaiseshomeimprovement@gmail.com</a></span></li>
          </ul>
        </div>
      </div>
    ...
    <>
      ...
      <section className="about-intro">
        <div className="about-intro-inner">
          ...
          <h2 className="serif">Quietly raising the standard since 2000.</h2>
      ...
      <div className="contact-body">
        ...
        <div>
          ...
          {[
            ...
            { label: "Email", value: <a href="mailto:salaiseshomeimprovement@gmail.com">salaiseshomeimprovement@gmail.com</a> },
          ].map(ci => (
